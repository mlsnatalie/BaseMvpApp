...
public class SmoothListView extends ListView implements OnScrollListener {
    ...
    private void init(Context context) {
        ...
        mHeaderViewContent = (RelativeLayout) mHeaderView.findViewById(R.id.smooth_header_content);
        mHeaderTimeView = (TextView) mHeaderView.findViewById(R.id.smooth_header_refresh_time);
    ...
    public void setLoadMoreEnable(boolean enable) {
        ...
        if (!mEnablePullLoad) {
            ...
            //make sure "pull up" don't open a line in bottom when listview with one page
    ...
    private void resetHeaderHeight() {
        ...
        // is refreshing, just scroll back to open all the header.
        if (mPullRefreshing && height > mHeaderViewHeight) {
