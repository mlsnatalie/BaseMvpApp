...
public final class DeviceInfo {
    ...
    public static String getNetworkOperatorName(Context context) {
        ...
        try {
            ...
            LogUtils.e("getNetworkOperatorName", "" + e.getMessage(), e);
        }
        return provider;
    }
    ...
    public static int getNetworkType(Context context) {
        ...
        try {
            ...
            LogUtils.e("getNetworkType", "" + e.getMessage(), e);
        }
    ...
    public static String getNetworkTypeName(Context context) {
        ...
        if (networkType == NETWORK_TYPE_WIFI) {
            ...
            try {
                ...
                LogUtils.e("getNetworkTypeName", "" + e.getMessage(), e);
            }
        }
        return typeName;
    }
    ...
    public static int getNetworkClass(Context context) {
        ...
        if (networkType == NETWORK_TYPE_WIFI) {
            ...
            try {
                ...
                LogUtils.e("getNetworkClass", "" + e.getMessage(), e);
            }
        }
        return networkClass;
    }
    ...
    public static int getWifiRssi(Context context) {
        ...
        try {
            ...
            LogUtils.e("getWifiRssi", "" + e.getMessage(), e);
        }
        return asu;
    }
    ...
    public static String getOpenUDID(Context context) {
        ...
        try {
            ...
            LogUtils.d("InvocationTargetException", e.toString());
        } catch (NoSuchMethodException e) {
            LogUtils.d("NoSuchMethodException", e.toString());
    ...
    public static String getSHA1Fingerprint(Context context) {
        ...
        try {
            ...
            LogUtils.e("NameNotFoundException", e.toString());
        } catch (NoSuchAlgorithmException e) {
            LogUtils.e("NoSuchAlgorithmException", e.toString());
        } catch (CertificateEncodingException e) {
            LogUtils.e("CertificateEncodingException", e.toString());
        } catch (CertificateException e) {
            LogUtils.e("CertificateException", e.toString());
        }
        return null;
    }
