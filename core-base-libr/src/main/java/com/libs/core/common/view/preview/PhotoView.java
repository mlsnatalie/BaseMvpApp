package com.libs.core.common.view.preview;
...
public class PhotoView extends AppCompatImageView {
    ...
    private RotateChangeListener mRotateListener = new RotateChangeListener() {
...
//        return new Info(rect, mImgRect, mWidgetRect, mBaseRect, mScreenCenter, mScale, mDegrees, mScaleType);
        return new Info(rect, mImgRect, mWidgetRect, mDegrees, mScaleType);
    }
...
//        return new Info(rect, imgRect, widgetRect, baseRect, screenCenter, 1, 0, imgView.getScaleType());
        return new Info(rect, imgRect, widgetRect,  0, imgView.getScaleType());
    }
