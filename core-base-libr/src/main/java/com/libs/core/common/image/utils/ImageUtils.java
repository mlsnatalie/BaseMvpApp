package com.libs.core.common.image.utils;
...
public class ImageUtils {
    ...
    public static String saveBitmapToLocal(Context context, Bitmap bitmap) {
        String savePath = StorageUtils.getImageCacheDir(context) + File.separator + System.currentTimeMillis() + ".jpg";
        try {
    ...
    public static String convertUploadImage(Context context, String imgPath, boolean isDelete) {
        ...
        try {
            if (file.length() / 1024 > MAX_IMAGE_SIZE) {
                ...
                String newPath = StorageUtils.getImageCacheDir(context) + File.separator + System.currentTimeMillis() + ".jpg";
...
//                }
    ...
    public static String saveBitmapToSD(Context context, Bitmap bitmap) {
        // 图片默认保存路径
        String imgSavedPath = StorageUtils.getCacheDirectory(context,null) + File.separator + System.currentTimeMillis() + ".jpg";
