...
public class RiskDialog {
    ...
    private RiskDialog(Builder builder) {
    ...
    private View initDialog() {
        ...
        View rootView = View.inflate(builder.getContext(), R.layout.dialog_risk, null);
        rootView.setFocusable(true);
        rootView.setFocusableInTouchMode(true);
        //标题
        TextView mTitleView = rootView.findViewById(R.id.tv_title);
        //标题下的分隔线
...
//        TextView mMessageView = rootView.findViewById(R.id.message);
        // 底部按钮
        ImageView mNegativeButton = rootView.findViewById(R.id.iv_close);
...
//        mPositiveButton.setText(TextUtils.isEmpty(builder.getPositiveWord()) ? "" : builder.getPositiveWord());
    ...
    public void show() {
        ...
        mDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialog) {
                if (builder.getNegativeListener() != null) {
                    builder.getNegativeListener().onClick(null);
                }
            }
        });
    ...
    public static class Builder {
        ...
        public RiskDialog create() {

            return new RiskDialog(this);
        }
    }
