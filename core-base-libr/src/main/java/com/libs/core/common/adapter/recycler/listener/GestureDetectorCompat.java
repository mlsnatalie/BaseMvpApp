...
/**
 * 该类完全复制重写了android.support.v4.view.GestureDetectorCompat类
 * 解决之前final类无法继承的问题
 */
public class GestureDetectorCompat {
    ...
    static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
         ...
         * up events). Can only be true if there is a double tap onCrossMove attached.
         */
        ...
        /**
         * Creates a GestureDetector with the supplied onCrossMove.
         * You may only use this constructor from a UI thread (this is the usual situation).
         *
         * @param context  the application's context
         * @param listener the onCrossMove invoked for all the callbacks, this must
         *                 not be null.
         * @param handler  the handler to use
         * @throws NullPointerException if {@code onCrossMove} is null.
         * @see Handler#Handler()
         */
        ...
        /**
         * Sets the onCrossMove which will be called for double-tap and related
         * gestures.
         *
         * @param onDoubleTapListener the onCrossMove invoked for all the callbacks, or
    ...
    /**
     * Creates a GestureDetectorCompat with the supplied onCrossMove.
     ...
     * gestures.
     *
     * @param listener the onCrossMove invoked for all the callbacks, or
     *                 null to stop listening for double-tap gestures.
     */
    public void setOnDoubleTapListener(GestureDetector.OnDoubleTapListener listener) {
