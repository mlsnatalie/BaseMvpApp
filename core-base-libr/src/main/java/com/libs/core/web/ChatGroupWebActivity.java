...
//public class ChatGroupWebActivity extends BaseRxActivity<BasePresenter> implements BaseView {
//
...
//    @BindView(R2.id.ll_message_setting)
//    LinearLayout ll_message_setting;
//    @BindView(R2.id.iv_message_setting)
...
//
//
//    @OnClick({R2.id.back_tv, R2.id.share_tv, R2.id.ll_message_setting, R.id.ll_exit_chat_group,
//            R.id.ll_master})
//    void onClick(View v) {
//        int id = v.getId();
//        if (id == R.id.back_tv) {
...
//        }*/ else if (id == R.id.ll_exit_chat_group) { //退出群聊
//
//        } else if (id == R.id.ll_message_setting) { //消息免打扰
//
//        } else if (id == R.id.ll_master) { //大咖精华
//
//        }
//    }
//
...
//    }
//
//    private boolean isHasExpand = false;
//
//    private void isShowSetting(boolean isShow) {
//        ll_setting.setVisibility(isShow ? View.VISIBLE : View.GONE);
//    }
//
//    //------------------------------------以上是错误页面相关----------------------------------------
//}
