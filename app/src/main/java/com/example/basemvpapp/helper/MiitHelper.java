...
import com.example.basemvpapp.Application;
...
public class MiitHelper implements IIdentifierListener {
    ...
    public void getDeviceIds(Context cxt) {
        ...
        if (nres == ErrorCode.INIT_ERROR_DEVICE_NOSUPPORT) {//1008612 不支持的设备
            Application.Companion.setIsSupportOaid(false, nres);
...
//            Application.setIsSupportOaid(false, nres);
            Application.Companion.setIsSupportOaid(false, nres);
    ...
    public void OnSupport(boolean isSupport, IdSupplier _supplier) {
       ...
       /* String oaid=_supplier.getOaid();
        ...
        Application.Companion.setIsSupportOaid(isSupport);
